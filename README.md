...
[![PyPI version](https://img.shields.io/pypi/v/streamgrabber.svg)](https://pypi.org/project/streamgrabber/)
[![Python](https://img.shields.io/pypi/pyversions/streamgrabber.svg)](https://pypi.org/project/streamgrabber/)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

## Installation

```bash
pipx install streamgrabber
```

> `pipx` is the recommended way to install CLI tools — it isolates dependencies automatically.
> Install pipx with `brew install pipx` (macOS) or `pip install pipx`.

Alternatively with pip:

```bash
pip install streamgrabber
```
